public class Main {
	...
	public static void main(String[] args) {
		String path = "../EstruturaDeDados3/src/";
		String pathAux = "../EstruturaDeDados3/password_classifier.csv";
		
		ClassificarSenha classificarSenha = new ClassificarSenha(path+"passwords.csv" );
